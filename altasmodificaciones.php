  ...
  ?>
        <div class="row pt-3">
            ...
            echo "<h3>Hubo un erro en los datos ingresados, verifique los datos!!! </h3>";
                ...
                <h2>Alta/modificacion de cliente</h2>
               <div class="pt-3">
                 ...
                 <div class="form-group"> 
                   ...
                   <br> 
                    ...
                    <br>
                       ...
                       <input type="submit" value="Guardar" class="btn btn-success" style="position:absolute;right:0%;top:90%;" > 
                      ...
                      <button type="submit" class="btn btn-danger" style="position:absolute;right:15%;top:90%;">Cancel</button>
                      </form>
